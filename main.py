...
# parser.add_argument('--resume', type=str, default='/home/annora/NetVLAD/output/runs/Sep22_21-01-35_vgg16_netvlad/', help='Path to load checkpoint from, for resuming training or testing.')
...
if __name__ == "__main__":
    ...
    encoder = nn.Sequential(*layers, L2Norm())
    model = nn.Module() 
