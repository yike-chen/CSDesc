...
root_dir = '/home/annora/NetVLAD/Pittsburgh'
...
queries_dir = join(root_dir, 'queries')
...
def get_whole_training_set(onlyDB=False, matfile='pitts30k_train.mat'):
    structFile = join(struct_dir, matfile)
    return WholeDatasetFromStruct(structFile,
                             input_transform=input_transform(),
                             onlyDB=onlyDB)

def get_whole_val_set(matfile='pitts30k_val.mat'):
    structFile = join(struct_dir, matfile)
    return WholeDatasetFromStruct(structFile,
                             input_transform=input_transform())
...
def get_whole_test_set(matfile = 'pitts30k_test.mat'):
    structFile = join(struct_dir, matfile)
    return WholeDatasetFromStruct(structFile,
                             input_transform=input_transform())
...
def get_training_query_set(margin=0.1, matfile='pitts30k_train.mat'):
    structFile = join(struct_dir, matfile)
